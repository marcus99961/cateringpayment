                    ...
                    <div class="shadow p-3 mb-5 rounded">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr v-for="(event, index) in events " :key="index" class="bg-transparent">
                                ...
                                <td><div v-for="packagge in packages"><div  v-if="event.id==packagge.event_id">{{ packagge.name }}</div></div></td>
                                <td>{{event.eholderName}} {{ event.mobile }}</td>
                                <td><button @click="depositPayment(event)" class="btn btn-primary btn-sm mx-1">Payment</button></td>
...
export default {
    ...
    methods: {
        ...
        getEvents(){
            ...
            axios.get('api/getEvents',{ params: { keyword: this.keyword } }).then(response=>{
