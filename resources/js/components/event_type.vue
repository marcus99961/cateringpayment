                    ...
                    <div class="shadow p-3 mb-5 rounded">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr v-for="(event, index) in events " :key="index" class="bg-transparent">
                                ...
                                <td><router-link :to="`/facilities/${ event.id }`" class="btn btn-sm btn-info">Facilities</router-link></td>
...
export default {
    ...
    methods: {
        ...
        getEvents(){
            ...
            axios.get('api/getEventtypes',{ params: { keyword: this.keyword } }).then(response=>{
